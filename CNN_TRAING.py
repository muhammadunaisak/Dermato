...
def read_dataset():
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\SREERAG\PycharmProjects\scd\src\static\dataset1')
    for pa in my_list:
        i=i+1
        if(i==10):
            break
        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\SREERAG\PycharmProjects\scd\src\static\dataset1\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\SREERAG\PycharmProjects\scd\src\static\dataset1\\'+pa, f)
...
#     mo = load_model(r"C:\Users\00000\Downloads\scd (2)\scd\src\model1.h5")
#
...
#     print(yhat_classes)
#
# print(predict(r"C:\Users\00000\Downloads\archive (3)\train\Acne and Rosacea Photos\07AcnePittedScars.jpg"))